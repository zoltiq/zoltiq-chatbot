...
use LLphp\Embeddings\DocumentUtils;
...
abstract class AbstractOpenAIEmbeddingGenerator implements EmbeddingGeneratorInterface
{
    ...
    {
/*
        if ($config instanceof OpenAI && $config->client instanceof ClientContract) {
    ...
    public function embedDocuments(array $documents): array
    {
        ...
        $texts = array_map('LLphp\Embeddings\DocumentUtils::getUtf8Data', $documents);
